...
ADynamicUAVRoutingSportsCar::ADynamicUAVRoutingSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDynamicUAVRoutingSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDynamicUAVRoutingSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDynamicUAVRoutingSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDynamicUAVRoutingSportsWheelRear::StaticClass();
