...
#include "DynamicUAVRoutingPlayerController.generated.h"

class UInputMappingContext;
class ADynamicUAVRoutingPawn;
class UDynamicUAVRoutingUI;
...
class ADynamicUAVRoutingPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<ADynamicUAVRoutingPawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<ADynamicUAVRoutingPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UDynamicUAVRoutingUI> VehicleUIClass;

	/** Pointer to the UI widget */
	UPROPERTY()
	TObjectPtr<UDynamicUAVRoutingUI> VehicleUI;
